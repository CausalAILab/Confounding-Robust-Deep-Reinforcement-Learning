...
class TorchEnv(VectorWrapper):
    def __init__(self, env: gymnasium.Env, device: torch.device | str) -> None:
        super().__init__(env)
        self.device = device
    ...
    def step(self, actions: Tensor | np.ndarray) -> Tuple[Tensor, Tensor, Tensor, Tensor, Dict[str, Any]]:
